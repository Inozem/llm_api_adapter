"""Google adapter facade for synchronous and asynchronous APIs."""
...
from .payloads import _GooglePayloadMixin
from .streaming import _GoogleStreamingMixin


@dataclass(repr=False)
class GoogleAdapter(
    _GooglePayloadMixin,
    _GoogleStreamingMixin,
    LLMAdapterBase,
):
    """Google adapter facade for both sync and async APIs."""
    ...
    async def achat(
        ...
        *,
        ...
        try:
            ...
            _ = previous_response
            _ = parallel_tool_calls
            client = GeminiAsyncClient(self.api_key)
