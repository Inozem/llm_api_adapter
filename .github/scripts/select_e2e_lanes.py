...
_ORGANIZATION_E2E_PATHS = {
    ...
    "zai": ("packages/organizations/zai/tests/e2e/",),
}
...
class E2ELaneSelection:
    ...
    def github_outputs(self) -> dict[str, str]:
        return {
            ...
            "zai": str(self.zai).lower(),
            "zai_e2e": str(self.zai_e2e).lower(),
        }
...
def select_e2e_lanes(changed_paths: Iterable[str]) -> E2ELaneSelection:
    ...
    zai = _organization_package_changed(paths, "zai")
    return E2ELaneSelection(
        ...
        zai_e2e=(
            ...
            or zai
            or e2e_harness
            or _matches(paths, _ORGANIZATION_E2E_PATHS["zai"])
        ),
    )
